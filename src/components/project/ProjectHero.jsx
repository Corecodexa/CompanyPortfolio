...
const ProjectHero = () => {
  ...
  return (
    <section
      ...
      aria-label="Core Codexa Projects Hero Section"
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          role="img"
          aria-label="Our diverse portfolio of digital projects"
        />
      ...
      >
        ...
        <div className="relative">
          <p className="text-gray-200 text-lg sm:text-xl md:text-2xl leading-relaxed mb-4 max-w-3xl mx-auto font-light">
            Explore our diverse portfolio of digital transformations and innovative 
            solutions that have empowered businesses across the globe.
          </p>
